...
class MapView extends Component {
  ...
  componentDidMount(){
   ...
   mapOptions = {center: myCenter1, zoom: 13};
  ...
  onMouseEnterHandler(i,name)
  {
    ...
    handleGo(ele)
    {
      ...
      this.setState({rests : ele});
        ...
        ReactDOM.render(<DetailedStyle rests = {ele} laPos={this.props.laPos} loPos={this.props.loPos}/>,c);
             ...
             <section>
               <div  className="mini-posts">
               {
                   this.props.res.map((ele,i)=> {
                     ...
                     return    <article  className="mini-post"   onMouseOver={()=>{this.onMouseEnterHandler(i,ele.restName)}} onMouseOut={()=>{this.onMouseLeaveHandler(i)}} onClick={()=>this.handleGo(ele)}>
